  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "طاحون الطيب — حيث تُطحن الأصالة ليفوح عبق الجودة. بر بلدي وعضوي من مرتفعات عسير والباحة، خلطات، عسل وسمن.",
      },
      { name: "theme-color", content: "#5C4024" },
    ],
    links: [
